        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden lg:flex items-center gap-6">
            <div className={`flex flex-col items-end ${isScrolled ? "text-slate-900" : "text-white"}`}>
              <span className="text-[10px] font-bold uppercase tracking-widest opacity-60">PEST EMERGENCY LINE</span>
      ...
      {isMobileMenuOpen && (
        <div className="xl:hidden bg-slate-900 text-white p-6 absolute top-full left-0 right-0 border-t border-slate-800 h-screen">
          <div className="flex flex-col gap-6">
            ...
            <div className="pt-6">
              <p className="text-slate-400 text-sm mb-2 uppercase tracking-widest font-bold">PEST CONTROL LINE</p>
