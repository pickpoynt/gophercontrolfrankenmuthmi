      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          ...
          <p className="text-xl text-slate-600 font-medium italic">
            Murrieta property owners trust us for master-grade electronic leak detection and precision foundation restoration. We provide specialized care for Riverside County.
          </p>
        </div>
          ...
          {[
            {
              ...
              description: "We utilize advanced frequency triangulation to identify sub-slab water breaches with clinical accuracy, avoiding unnecessary excavation in Murrieta homes.",
              link: "#contact"
            },
            {
              icon: Drill,
            ...
            },
            {
              ...
              description: "High-resolution infrared diagnostics designed to identify hot water line breaks specifically under Southern California's unique geological conditions.",
              link: "#contact"
            },
            {
              icon: Waves,
